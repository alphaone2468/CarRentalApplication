                  ...
                  {cars.map((car) => (
                    <div key={car.id} className="card">
                      <div className="imageContainer">
                        <img src={car.images} alt={car.name} className="carImage" onClick={()=>navigate(`/car-details/${car._id}`)} />
                      ...
                      <div className="cardContent">
                        <h3 className="carName">{car.model}</h3>
                        ...
                        <div className="specs">
                          <div className="spec">
                            ...
                            <span>{car.features.seater} Seats</span>
                          </div>
                          <div className="spec">
                            <Fuel size={16} className="icon" />
                            <span>{car.features.driveType}</span>
                          </div>
                          <div className="spec">
